...
public class ProductController {
    ...
    public ResponseEntity<String> postNewPromo(@RequestBody PostDto postDto) {
        postService.createPromoPost(postDto);
        return new ResponseEntity<>("Promoción creada exitosamente", HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> createPost(@RequestBody PostDto postDto) {
        ...
        return new ResponseEntity<>("Post creado exitosamente", HttpStatus.OK);
    }
