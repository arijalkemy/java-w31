...
public class PublicationService implements IPublicationService {
    ...
    private List<FollowedPublicationDto> pubsByOrder(Stream<FollowedPublicationDto> followedPublicationDtoStream, String order) {

        DateOrder orderBy = DateOrder.fromString(order);
        if (DateOrder.DATE_ASC.equals(orderBy)) {
            return followedPublicationDtoStream
