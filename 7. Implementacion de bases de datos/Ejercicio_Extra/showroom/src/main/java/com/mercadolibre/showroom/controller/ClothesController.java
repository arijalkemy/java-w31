...
public class ClothesController {
    ...
    @GetMapping("/{code}")
    public ResponseEntity<ClothingItemDto> getClothingItemByCode(@PathVariable Long code) {
        return ResponseEntity.ok(clothesService.findById(code));
    }

    @PutMapping("/{code}")
    public ResponseEntity<ClothingItemDto> updateClothingItem(@PathVariable Long code, @RequestBody ClothingItemDto updatedItem) {
        return ResponseEntity.ok(clothesService.update(code, updatedItem));
    }

    @DeleteMapping("/{code}")
    public ResponseEntity<Void> deleteClothingItem(@PathVariable Long code) {
