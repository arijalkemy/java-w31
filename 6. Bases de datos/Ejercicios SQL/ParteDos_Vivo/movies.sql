...
Mostrar el título de todas las series y usar alias para que tanto 
...
Mostrar el título de las películas, el rating y los premios de las 
películas con un rating mayor a 7.5 y con más de dos premios.
SELECT title AS titulo, rating, awards AS premios
FROM movies
WHERE rating > 7.5 AND awards > 2;

Mostrar el título de las películas y el rating ordenadas por rating en 
forma ascendente.
