...
SELECT title AS Titulo FROM series AS Nombres_de_series;
...
SELECT title AS Titulo, release_date AS fecha_estreno FROM movies WHERE release_date BETWEEN '2004-01-01' AND '2008-12-31';
