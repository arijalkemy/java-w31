...
INSERT INTO movies VALUES (22,NULL,NULL,'la la land',9.0,3,'2016-10-04 00:00:00',120,12);

-- PUNTO 2
-- Agregar un género a la tabla genres.
INSERT INTO genres VALUES (13,'2016-10-04 00:00:00',NULL,'romantico',13,1);
...
-- Modificar la tabla actors para que al menos un actor tenga como favorita la película agregada en el punto 1.
 UPDATE actors SET favorite_movie_id = 22 WHERE id = 1;  -- Cambia el `id` según sea necesario
