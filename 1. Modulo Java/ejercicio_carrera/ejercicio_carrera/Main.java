...
public class Main {
        ...
        public static void main(String[] args) {
                ...
                Participante participante1 = new Participante(1, 12345678, "Juan", "Pérez", 25, "123456789",
                                "987654321", "O+");
                Participante participante2 = new Participante(2, 87654321, "Ana", "Gómez", 17, "987654321", "123456789",
                                "A+");
                Participante participante3 = new Participante(3, 11223344, "Carlos", "López", 30, "111222333",
                                "444555666",
                                "B+");
                Participante participante4 = new Participante(4, 55667788, "María", "Martínez", 22, "222333444",
                                "555666777",
                                "O-");
                Participante participante5 = new Participante(5, 99887766, "Luis", "García", 28, "333444555",
                                "666777888",
                                "AB+");
                Participante participante6 = new Participante(6, 44332211, "Sofía", "Hernández", 19, "444555666",
                                "777888999",
                                "A-");
                Participante participante7 = new Participante(7, 66778899, "Miguel", "Torres", 35, "555666777",
                                "888999000",
                                "B-");
                Participante participante8 = new Participante(8, 22334455, "Laura", "Ramírez", 26, "666777888",
                                "999000111",
                                "O+");
                Participante participante9 = new Participante(9, 77889900, "Diego", "Flores", 21, "777888999",
                                "000111222",
                                "AB-");
                Participante participante10 = new Participante(10, 33445566, "Camila", "Vargas", 24, "888999000",
                                "111222333",
                                "A+");
                Participante participante11 = new Participante(11, 88990011, "Javier", "Castro", 29, "999000111",
                                "222333444",
                                "O-");
                Participante participante12 = new Participante(12, 44556677, "Valeria", "Morales", 18, "000111222",
                                "333444555",
                                "B+");
                ...
                for (Inscripcion inscripcion : inscripciones1) {
                        ...
                        System.out.println(
                                        "Participante: " + inscripcion.participante.nombre + " "
                                                        + inscripcion.participante.apellido
                                                        + " numero de participante: "
                                                        + inscripcion.participante.numero);
                        System.out.println();
                }
                // Categoria media
