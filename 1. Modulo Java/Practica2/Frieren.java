...
public class Frieren {
	...
	//Crear 3 objetos de tipo categoría (uno por cada categoría) con sus respectivos datos.
			...
			dependiendo de su dificultad y 
			de ellas se guarda una id, el nombre y una breve descripción:
				...
				public static void main(String[] args) {
					...
					//Crear 3 objetos de tipo categoría (uno por cada categoría) con sus respectivos datos.
//					se guarda una id, el nombre y una breve descripción
					...
					HashMap<String, String> categoria1 = new HashMap();
			...
			//Crear un nuevo participante e inscribirlo en una categoría. Calcular el monto de inscripción que deberá abonar (Por ejemplo: si el participante se inscribe a la categoría Circuito chico y tiene 21 años, el monto a abonar es de $1500).
					...
					/*
					 * 	
			Para poder conocer en qué categoría competirá cada participante 
			se manejarán inscripciones.

					 * Cada inscripción debe contar con un número de inscripción, 
			una categoría, 
			un participante 
			y el monto a abonar por el participante.
					 * 
					 * 
