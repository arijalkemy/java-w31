...
public class StarWarsService {
    ...
    public StarWarsService() {
        this.personajes = List.of(
                new Personaje("Luke Skywalker", 172, 77, "Blonde", "Fair", "Blue", "19BBY", "male", "Tatooine",
                        "Human"),
                new Personaje("Darth Vader", 202, 136, "Black", "White", "Yellow", "41.9BBY", "male", "Tatooine",
                        "Human"),
                new Personaje("Leia Organa", 150, 49, "Brown", "Light", "Brown", "19BBY", "female", "Alderaan",
                        "Human"),
