...
VALUES (
           101, 50, 48, '2025-07-09 07:00:00', '2025-07-01',  5.0,  1.0,
           (SELECT id FROM frescosG9.product WHERE name='Test Product 1'),
           (SELECT id FROM frescosG9.sector WHERE sector_code=101 AND warehouse_id=(SELECT id FROM frescosG9.warehouse WHERE warehouse_code=1001)),
