...
We adopt the versioning system [semver](https://semver.org/): **MAJOR.MINOR.PATCH**

- MAJOR version that has changes incompatible with previous versions
- MINOR version with compatible changes, which adds new features, improvements
- PATCH version with compatible changes, fixes or minimal changes
