...
public class UserRepositoryImpl implements IUserRepository {
    ...
    static {
        ...
        posts.add(new Post(3, 1, LocalDate.now().minusDays(3), products.get(8), 120, 100.0));
        posts.add(new Post(3, 2, LocalDate.now().minusDays(3), products.get(0), 50, 200.0));
        posts.add(new Post(3, 3, LocalDate.now().minusDays(3), products.get(1), 30, 150.0));
        posts.add(new Post(3, 4,LocalDate.now().minusDays(3) , products.get(2), 70, 80.0));
        posts.add(new Post(3, 5, LocalDate.now().minusDays(3), products.get(3), 90, 300.0));
        posts.add(new Post(5, 6,LocalDate.now().minusDays(3) , products.get(4), 40, 120.0));
        posts.add(new Post(5, 7, LocalDate.now().minusDays(3), products.get(5), 60, 1000.0));
        posts.add(new Post(5, 8, LocalDate.now().minusDays(3), products.get(6), 80, 500.0));
        posts.add(new Post(2, 9, LocalDate.now().minusDays(3), products.get(7), 20, 700.0));
        posts.add(new Post(2, 10, LocalDate.now().minusDays(3), products.get(9), 100, 250.0));
        posts.add(new Post(2, 11, LocalDate.now().minusDays(3), products.get(10), 110, 300.0));
        ...
        users.add(new User(7, "Diana", new ArrayList<>(), new ArrayList<>(Arrays.asList(4, 6)), new ArrayList<>()));
