...
public class TestDataFactory {
        ...
        public static List<Post> createSixPosts() {
                ...
                String dateMinusThreeWeeks = String.valueOf(LocalDate.now().minusWeeks(3));
                String dateMinusFiveWeeks = String.valueOf(LocalDate.now().minusWeeks(5));

                posts.add(new Post(100, 1, dateNow, products.get(0), 1, 1000.0, false, 0.0));
                posts.add(new Post(100, 2, dateMinusThreeWeeks, products.get(1), 1, 500.0, true, 5.0));
                posts.add(new Post(200, 3, dateMinusThreeWeeks, products.get(2), 2, 700.0, false, 0.0));
                posts.add(new Post(201, 4, dateNow, products.get(3), 1, 200.0, false, 0.0));
                posts.add(new Post(300, 5, dateMinusFiveWeeks, products.get(4), 3, 300.0, true, 10.0));
                posts.add(new Post(301, 6, dateNow, products.get(5), 2, 60.0, false, 0.0));
                return posts;
        }
