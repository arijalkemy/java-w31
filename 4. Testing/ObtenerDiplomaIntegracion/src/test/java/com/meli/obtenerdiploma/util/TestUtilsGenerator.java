...
public class TestUtilsGenerator {
    ...
    public static void appendNewStudent(StudentDTO stu) {
        ...
        try {
            String content = Files.readString(new File("./src/" + "main" + "/resources/users.json").getAbsoluteFile().toPath(), StandardCharsets.US_ASCII);
            writer = new PrintWriter(ResourceUtils.getFile("./src/" + "main" + "/resources/users.json"));
