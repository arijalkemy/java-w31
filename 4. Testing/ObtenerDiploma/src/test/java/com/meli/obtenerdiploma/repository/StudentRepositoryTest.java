...
public class StudentRepositoryTest {
    ...
    public void findAllStudentsTest() {
        ...
        Assertions.assertEquals(expectedStudents.size(), obtained.size());
        //Assertions.assertTrue(obtained.containsAll(expectedStudents));
        //Assertions.assertTrue(expectedStudents.containsAll(obtained));
    }
